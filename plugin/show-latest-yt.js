/**
 * show-latest-yt is a javascript, to embed the latest video or the current live video from a YouTube channel into your Website.
 * The script is based on HOAPlayer from Robert Pitt and Moritz Tolxdorff
 * 
 * @package WordPressPlugin
 * @subpackage show-latest-yt-javascript
 * @author Robert Pitt <https://plus.google.com/110106586947414476573/about>
 * @author Moritz Tolxdorf <https://plus.google.com/117596712775912423303/about>
 * @author Peter Liebetrau <https://plus.google.com/u/0/102408750978338972864/about>
 * @copyright (c) 2012, Robert Pitt, Moritz Tolxdorff, Peter Liebetrau
 * @version V1.0
 * @since V1.0
 * @license http://www.gnu.org/licenses/ GPL V3 or greater
*/
(function(){
    /**
    ...
    */
    var ShowLatestYt = function()
    {
        ...
        */
        this.config = this.mergeObjects(this.config, window["_showlatestyt_config"] || {});
    ...
    */
    ShowLatestYt.prototype.onDomLoaded = function(e)
    {
        /**
         * Scan the DOM for all the elements that have the classname onair
        */
        var targets = document.getElementsByClassName('showlatestyt'), i;
    ...
    */
    ShowLatestYt.prototype.loadVideoPlayer = function(target, uid, width, height)
    {
        /**
    ...
    */
    ShowLatestYt.prototype.fetchUserFeed = function(uid, flag, callback)
    {
        /**
        ...
        */
        this.awaitLoadResponse(magic, callback);
    ...
    ShowLatestYt.prototype.awaitLoadResponse = function(magic, callback)
    {
    ...
    */
    ShowLatestYt.prototype.bindOnload = function(callback)
    {
        /**
    ...
    */
    ShowLatestYt.prototype.mergeObjects = function()
    {
        var buildObject = {}, i, e;
    ...
    */
    window["_showlatestyt_instance_"] = new ShowLatestYt();
})()